      ...
      <section className="text-gray-600 body-font bg-white">
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          ...
          <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
            ...
            <div className="flex flex-col mb-10 lg:items-start items-center">
              <div className="w-14 h-14 inline-flex items-center justify-center rounded-full bg-yellow-100 text-yellow-500 mb-5">
<GrYoga className="w-9 h-9"/>
              </div>
              <div className="flex-grow">
                <h2 className="text-gray-900 text-lg title-font font-medium mb-3">RIA Yoga Studio</h2>
                <p className="leading-relaxed text-base">
                Join our expert-led yoga sessions for improved physical and mental well-being. Perfect for all levels.
                </p>
                <Link href={'/riayoga'} className="mt-3 text-red-500 inline-flex items-center  font-semibold">
                  Learn More
                  <svg
                    fill="none"
                    stroke="currentColor"
