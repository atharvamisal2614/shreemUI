...
function Navbar() {
  ...
  const getLinkClasses = (path) =>
    `text-lg font-semibold px-3 py-2 rounded-full transition duration-300 ease-in-out ${activeLink === path
  ...
  return (
    <>
      {/* Main Navbar */}
      <header className="text-gray-600 body-font p-5  z-10 bg-yellow-400">
      ...
      <div
        className={`fixed inset-0 z-20 bg-yellow-400 bg-opacity-100 transform ${isOpen ? 'translate-x-0' : 'translate-y-full'
...
//       {/* Main Navbar */}
//       <header
//         className={`text-gray-600 body-font p-5 sticky top-0 z-10 transition-transform duration-300 ${
//           isScrolled ? 'bg-transparent' : 'bg-yellow-400'
//         } ${isVisible ? 'transform translate-y-0' : 'transform -translate-y-full'}`}
//       >
//         <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center justify-between">
//           {/* Logo */}
//           <Link href={'/'}>
//             <Image src={"/shreem-logo-og.png"} height={60} width={60} alt="Shreem-logo" />
//           </Link>
