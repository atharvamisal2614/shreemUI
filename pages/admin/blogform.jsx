...
//         >
//           <FaUserCircle className="text-4xl cursor-pointer hover:text-red-500 transition duration-300" />
//         </button>
...
//               className="w-full text-left text-gray-700 hover:text-red-500 py-2 transition duration-200"
//             >
//               All Blogs
//             </button>
//             <button
  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col items-center mt-6 text-red-500">
        ...
        <div className="w-36 h-0.5 bg-gray-400 mt-10" /> {/* Thin underline */}
        ...
        {showMenu && (
          <div className="mt-4 bg-white shadow-lg rounded-lg py-2 px-4 absolute top-16 transition-transform duration-300 ease-out transform">
            <button
              onClick={() => router.push(`${BASE_URL}/admin/allblogs`)}
              className="w-full text-left text-gray-700 hover:text-yellow-500 py-2 transition duration-200"
            >
              All Blogs
            </button>
            <button
